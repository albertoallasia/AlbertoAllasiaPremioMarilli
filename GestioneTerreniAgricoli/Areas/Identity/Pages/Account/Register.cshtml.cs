...
namespace GestioneTerreniAgricoli.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IdentityContext _appContext;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var userType = (string)Input.UserType;
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!roleExists)
                    {
                        _logger.LogInformation($"Adding {userType} Role");
